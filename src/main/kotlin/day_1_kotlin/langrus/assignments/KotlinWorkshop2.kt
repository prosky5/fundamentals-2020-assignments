...
object KotlinWorkshop2 {
    ...
    fun main(args: Array<String>) {
        ...
        val numbersArray = arrayOfNulls<Int>(5)
        ...
        while (counter < size) {
            ...
            // TODO 4: Сохрани и добавь введённые с клавиатуры числа в массив "numbersArray" согласно следующей логике:
            ...
            when (userInput) {
                ...
                5 -> numbersArray[counter] = userInput.times(size)
                9 -> numbersArray[counter] = userInput.plus(size)
            }
